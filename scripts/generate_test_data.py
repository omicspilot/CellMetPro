...
METABOLIC_GENES: dict[str, list[str]] = {
    "Glycolysis":           ["HK1", "HK2", "GPI", "PFKL", "ALDOA", "GAPDH", "PGK1", "PKM", "LDHA", "ENO1"],
...
SIGNATURES: dict[str, dict[str, float]] = {
    "CD4_T": {
        # glycolysis up
        "LDHA": 40, "PKM": 35, "SLC2A1": 30, "GPI": 25, "GAPDH": 45, "ENO1": 30,
        # OXPHOS moderate
        "COX5A": 20, "ATP5A1": 18, "NDUFS1": 15,
        # FAO low
        "CPT1A": 3, "ACADM": 3,
    },
    "M1_Macrophage": {
        # aerobic glycolysis (Warburg)
        "HK2": 50, "PFKL": 40, "LDHA": 55, "PKM": 45, "ALDOA": 35, "ENO1": 38,
        # OXPHOS suppressed
        "NDUFS1": 5, "SDHB": 5, "COX5A": 6, "ATP5A1": 6,
        # inflammatory / glutaminolysis
        "GLS": 25, "GLUD1": 20,
    },
    "Naive_B": {
        # FAO signature
        "CPT1A": 40, "ACADM": 38, "HADHA": 35, "ACADVL": 30,
        # TCA moderate
        "IDH1": 22, "MDH2": 20, "CS": 18,
...
def _build_population(cell_type: str, n_cells: int, gene_names: list[str]) -> np.ndarray:
